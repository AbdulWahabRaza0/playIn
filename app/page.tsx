...
export default function Home() {
  ...
  return (
    mount && (
      <>
        <Wrapper ms="3.29%" me="3.4%" mt="30px" mb="1%">
          <Navbar />
          <Spacer height="25px" />
          <Wrapper height="auto" className="d-flex flex-row align-items-center">
          ...
          <Wrapper id="marquee" mt="3%">
            <MarqueeSlider>
              <H1 fontSize="73px" weight="bold">
